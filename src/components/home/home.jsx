        ...
        <div className='w-2/3 grid gap-3 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 text-center text-2xl font-bold mx-4'> 
            {
                ...
                <div className='mb-0 w-full flex mx-auto justify-center items-end'><button className='w-full flex mx-auto justify-center items-end text-white text-center bg-[#2F80ED]'>Select</button></div>
            </div>)
            }
            </div>
